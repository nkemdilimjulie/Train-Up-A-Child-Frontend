...
//       formData.append("photo", ""); // clear the photo
...
//       <h1 className="text-3xl font-bold mb-6 text-blue-700 text-center">Children List</h1>
...
//           const photoPath = child.photo || "";
//           const photoUrl = photoPath
//             ? `${BACKEND_URL}/media/${photoPath.replace(/^\/+/, "")}`
//             : null;
...
//                       setSelectedCaption(
//                         `${child.first_name || ""} — Age: ${child.age || "N/A"} — Class: ${
...
//                     onChange={(e) =>
//                       e.target.files.length && handleUploadPhoto(child.id, e.target.files[0])
//                     }
//                   />
//                 </div>
//               )}
...
//               </p>
//               {child.age && <p className="text-gray-600 text-sm mb-1">Age: {child.age}</p>}
//               {child.class_name && (
//                 <p className="text-gray-600 text-sm mb-1">Class: {child.class_name}</p>
//               )}
//               {child.guardian_name && (
//                 <p className="text-gray-500 text-sm">Guardian: {child.guardian_name}</p>
//               )}
//             </div>
//           );
//         })}
